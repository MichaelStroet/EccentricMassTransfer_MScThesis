...
def evolve_giant(giant_in_code, stop_radius, dirs, parameters):
    """
...
def A_EvolveGiant(evolution_code, dirs, parameters):
    ...
    evolved_giant, HR_data = evolve_giant(giant_in_code, stop_radius, dirs, parameters)
    ...
    animate_HR(HR_data, dirs, parameters)
